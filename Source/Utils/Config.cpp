...
juce::String queueHeaderFile = "File";
juce::String queueHeaderSize = "Size";
juce::String queueHeaderDate = "Modified";
juce::String errorNoValidFiles = "No valid audio files found in folder.";
